 ...
 */@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = As.PROPERTY, property = "__class", defaultImpl = com.zetapush.core.callBrick.Call$Impl.class)
@JsonSubTypes({
	@Type(value = com.zetapush.core.callBrick.Call$Impl.class, name = "com.zetapush.core.callBrick.Call") })
