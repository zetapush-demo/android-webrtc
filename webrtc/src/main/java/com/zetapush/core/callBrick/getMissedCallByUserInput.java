 ...
 */@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = As.PROPERTY, property = "__class", defaultImpl = com.zetapush.core.callBrick.getMissedCallByUserInput$Impl.class)
@JsonSubTypes({
	@Type(value = com.zetapush.core.callBrick.getMissedCallByUserInput$Impl.class, name = "com.zetapush.core.callBrick.getMissedCallByUserInput") })
